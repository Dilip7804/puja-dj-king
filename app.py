...
# --- SHARED GALLERY RENDER FUNCTION (Auto-Clear Inputs Fixed) ---
def render_gallery_section():
    ...
    # --- SUB-TAB 2: ADD MEDIA (With Auto-Clear Inputs using St.form) ---
    with action_tabs[1]:
        ...
        # st.form ka use karne se save hote hi saare inputs automatically khali ho jate hain
        with st.form(f"add_media_form_{type_str}", clear_on_submit=True):
            ...
            if submit_media:
                ...
                if media_title.strip() and saved_source:
                    ...
                    st.success("✅ Media Safalpurvak Add Ho Gaya aur boxes khali kar diye gaye!")
                    st.rerun()
